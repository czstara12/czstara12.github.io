...
5. 电脑选择配置参数 并复制下面的命令行![image-20210725170208651](../img/image-20210725170208651.png)
6. 树莓派命令行执行JLinkGDBServer + 你刚才复制的参数
7. ![image-20210725170238510](../img/image-20210725170238510.png)调试探头选jlink 上面选连接远程... 主机名或IP地址填上树莓派的IP地址 端口不用变
